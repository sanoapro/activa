...
| | Decisión | Dónde vive |
|---|---|---|
| A | Flip-Touch seminueva de alumno: **$7,000** (lista definitiva del 22-ago) | `DEVICES.flAlumno` |
| B | Chromebook nueva sigue en **$14,500 / $17,850** | `DEVICES.cbAlumno` / `DEVICES.cbDocente` |
| C | CEU **$870**; seguro **$1,050 / $1,600 / $2,150** (2/3/4 años). **Corregido el 22-ago-2026:** el 21 se habían copiado del catálogo de arrendamiento, que va SIN IVA, y cotizaban de menos | `APP_CONFIG.equipment.ceuUnitCost` / `insuranceByYears` |
...
- El ejemplo canónico da exactamente lo del plan: fierro $552,200 → **$197.21** por alumno y año
  → lista **$3,197.21** (probado en la suite y reproducido por la interfaz real en la prueba DOM).
