...
>
> **integra** reúne la comunicación, el control y la gestión de tu escuela en un solo lugar.
>
> **Comunicación:** avisos, notificaciones y seguimiento con las familias.
>
> **Control:** calificaciones, boletas y el expediente de cada alumno.
>
> **Gestión:** colegiaturas, control de acceso, cafetería y extracurriculares.
>
> Y algo que la hace distinta: se sincroniza de forma **nativa con la Consola de Google**. Las
> cuentas y las clases se dan de alta una sola vez. Sin doble captura para tu equipo de sistemas.
>
> Lo mejor es lo que **no** te pide: integra está diseñada para convivir con lo que tu colegio ya
> usa, no para reemplazarlo.
>
...
|---|---|---|
| 0:00–0:12 | Escritorio con cuatro ventanas abiertas y una hoja de cálculo; la misma lista de alumnos capturada tres veces | El problema: sistemas sueltos |
| 0:12–0:18 | Todo se colapsa en una sola pantalla; entra el logo **integra** | La promesa |
| 0:18–0:38 | Tres bloques con su color: comunicación (azul), control (rojo), gestión (verde) | Los tres pilares |
| 0:38–0:50 | Diagrama: Consola de Google ⇄ integra, una sola alta de cuentas | El diferenciador |
